...
public abstract class PieceLogic : IPieceLogic
{
   ...
   protected List<(int, int)> Directions = new List<(int, int)>(); // Possible directions off attacks for long range pieces
   ...
   public virtual bool CanCaptureEnemyKing(Board board) // Accessory method used for checking legality of a move
   {
